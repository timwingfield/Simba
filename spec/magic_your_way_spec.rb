...
describe MagicYourWay do
  ...
  describe "and getting adult base ticket prices" do
  ...
  describe "and getting adult park hopper ticket prices" do
  ...
  describe "and getting a hopper and water park option" do
    ...
    it "should 335 for a 6 day ticket" do
      @myw.adult.days(6).park_hopper.water_park_fun_and_more.price.should be(335)
    end
  end
